const renderSet = (themeName, setName, colors) => {
  const colorMap = {
    ...
    'background-alt': colors.shade1,
    'background-attention': colors.shade0,
    border: colors.shade1,
    'current-line': colors.shade3,
    selection: colors.shade3,
    foreground: colors.shade6,
    'foreground-alt': colors.shade5,
    'foreground-attention': colors.shade7,
    comment: colors.shade4,
    red: colors.accent0,
    orange: colors.accent1,
  ...
  let output = []
  output.push(`# generated by themer-qutebrowser
# ${setName} variant of theme ${themeName}
def themer(c, options = {}):
  palette = {`)
...
module.exports.render = (colors, options) => {
  ...
  for (var set in colorSets) {
    ...
    let data = {name: colorSets[set].name + '.py', contents: Buffer.from(theme, 'utf8')}
    promises.push(Promise.resolve(data))
  }
  promises.push(Promise.resolve({name: '__init__.py', contents: Buffer.from('', 'utf8')}))
